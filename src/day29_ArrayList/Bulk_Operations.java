...
public class Bulk_Operations {
    public static void main(String[] args) {
        ...
        numbers.addAll(Arrays.asList(100, 200, 300, 4000, 500, 600, 700, 100, 200, 300, 800, 900));
        ...
        namesList.addAll(Arrays.asList(names));// this is one way of converting arrays to arraysList
         */
