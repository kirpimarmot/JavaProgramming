...
public class UnaryOperators {
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------");
         int x = 200;
        System.out.println(--x);//pre decrement; decrease the value by 1 straight away = 199
        int y = 200;
        System.out.println(y--);// post decrement: first passes the correct value, then decrease the value by 1
        ...
        System.out.println(q--);//29, now the value becomes q=28
