...
public class AmazonInc {
    public static void main(String[] args) {
        ...
        ProductOwner po= new ProductOwner("Suhaib", 29, 'M', 1, 110000, company);

        BusinessAnalyst ba=new BusinessAnalyst("Cihad", 30,'M',2, 100000,company);

        ScrumMaster sm = new ScrumMaster("Anel", 26,'F', 3, 150000, company);
