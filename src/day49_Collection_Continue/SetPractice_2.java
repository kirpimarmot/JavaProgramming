...
public class SetPractice_2 {
    ...
    */
        ...
        // we converted to Arraylist to be able to retrieve the name in the second index number//Set does not maintain index number
        System.out.println(names.toArray(new String[0])[2]);

        //we converte to ArraysList to be able to retrieve the name on the 4th index//Set does not maintain index number
