...
public class ListOfMap_Practice_1 {
    ...
    public static void main(String[] args) {
        ...
        for (Map<String, String> eachScrumTeam : scrumTeams) {
            /*for (String eachKey : eachScrumTeam.keySet()) {// First approach
                if (eachScrumTeam.get(eachKey).equals("SM")){
                    System.out.println(eachKey );
                }
            }*/
            for (Map.Entry<String, String> eachEntry : eachScrumTeam.entrySet()) { //Second approach
                if (eachEntry.getValue().equals("SM")) {
        ...
        for (Map<String, String> eachScrumTeam : scrumTeams) {
            for (Map.Entry<String, String> eachEntry : eachScrumTeam.entrySet()) {
